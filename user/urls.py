...
from .views import FetchPayPalAddressView, MileageRecordListView, UpdatePayPalAddressView,  UserRegistrationAPIView, UserDetailView, VendorDetailView,  MileageRecordCreateView, FacebookLogin
